...
import Pranav from "../assets/panni.jpg";
    ...
    <div className="font-lexend bg-rp-black lg:h-screen h-full">
      ...
      <div className="lg:flex justify-around mt-5 lg:mt-32">
        <div className="mx-auto mt-5 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          <div className="h-2/5 bg-mj-yellow rounded-t-md overflow-hidden"></div>
          <img
            src={Pranav}
            alt="developer"
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/pranav-wadhekar/"
                target="blank"
              >
                {" "}
              ...
              <a
                href="https://www.instagram.com/wadhekarpranav/"
                target="blank"
              >
                {" "}
                <img src={instagram} alt="instagram" className="h-8 w-8" />
              </a>
              <a href="https://github.com/pranavWadhekar" target="blank">
                {" "}
        ...
        <div className="mx-auto mt-5 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/tambekarganesh/"
                target="blank"
              >
                {" "}
                <img src={linkedin} alt="linkdein" className="h-8 w-8" />
              ...
              <a
                href="https://www.instagram.com/ganesh_t.12/"
                target="blank"
              >
                {" "}
                <img src={instagram} alt="linkdein" className="h-8 w-8" />
              </a>
              <a href="https://github.com/ganeshtambekar" target="blank">
                {" "}
                <img src={github} alt="github" className="h-8 w-8" />
              </a>
            </div>
        ...
        <div className="mx-auto my-5 lg:mb-0 lg:mt-0 lg:mx-0 bg-jp-black relative shadow-slate-700 shadow-md rounded-md w-72 h-96">
          ...
          <div className="mt-20 flex flex-col items-center justify-center ">
            ...
            <div className="w-36 flex justify-between mt-6">
              <a
                href="https://www.linkedin.com/in/abhishekchavan8252/"
                target="blank"
              >
                {" "}
                <img src={linkedin} alt="linkdein" className="h-8 w-8" />
              </a>
              <a href="https://www.instagram.com/abhi_chavan__04/" target="blank">
                {" "}
                <img src={instagram} alt="instagram" className="h-8 w-8" />
              </a>
              <a href="https://github.com/Abhishek8252 " target="blank">
                {" "}
                <img src={github} alt="github" className="h-8 w-8" />
              </a>
            </div>
